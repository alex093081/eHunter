...
! function(t) {
    ...
    var WnacgAlbumService = (function() {
        ...
        // 將 fetchHtml 和新的 getImageDimensions 放在閉包的最頂層
            ...
            return new Promise(function(resolve, reject) {
                ...
                GM_xmlhttpRequest({
                    ...
                    onload: function(response) {
                        ...
                        else { reject(new Error("Request failed: " + response.status)); }
                    },
        ...
        var getImageDimensions = function(url) {
            return new Promise(function(resolve, reject) {
                ...
                img.onerror = function() {
                    console.warn("Could not load first image to get dimensions, using fallback ratio.");
                    resolve({ width: 1, height: 1.4 }); // 提供一個安全的備用值
                };
                img.src = url;
            });
        };
                ...
                return Promise.all(dimensionPromises).then(function(dimensionsArray) {
                    ...
                    _this.imgPageInfos = imgArray.map(function(item, index) {
                        ...
                        return {
                            ...
                            heightOfWidth: ratio, // 应用每张图片各自的精确比例
