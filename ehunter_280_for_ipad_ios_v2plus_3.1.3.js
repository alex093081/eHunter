...
// @version      2.8.0_3.1.3
// @description  This extension provides a scroll mode and book mode to e-hentai/exhentai/nhentai, for the best reading experince!  此擴展為e-hentai/exhentai/nhentai提供一個滾動模式和書本模式, 提供良好的閱讀體驗. 防止重複下載(&分頁)_設定獨立_繁體_修復第一頁重複讀取_修復縮略圖欄圓
...
! function(t) {
	...
	var r = n(9),
		...
		u = function(t, e, n) {
			...
			for (c in h && (n = e), n) f = ((l = !p && b && void 0 !== b[c]) ? b : n)[c], d = v && l ? s(f, r) : g && "function" == typeof f ? s(Function.call, f) : f, b && a(b, c, f, t & u.U), _[c] != f && o(_, c, d), g && y[c] != f && (y[c] = f)
		};
	...
	t.exports = function(t, e) {
		...
		return function(e, s, h) {
			for (var m, g, v = o(e), b = i(v), _ = r(s, h, 3), y = a(b.length), w = 0, x = n ? p(e, y) : u ? p(e, 0) : void 0; y > w; w++)
				if ((d || w in b) && (g = _(m = b[w], w, v), t))
					if (n) x[w] = g;
					else if (g) switch (t) {
				case 3:
					return !0;
		...
		function(t, n) {
			...
			function ce(t) {
				return s(t) ? [bt(t)] : Array.isArray(t) ? function t(e, n) {
					var r, u, c, l, f = [];
					for (r = 0; r < e.length; r++) i(u = e[r]) || "boolean" == typeof u || (l = f[c = f.length - 1], Array.isArray(u) ? u.length > 0 && (le((u = t(u, (n || "") + "_" + r))[0]) && le(l) && (f[c] = bt(l.text + u[0].text), u.shift()), f.push.apply(f, u)) : s(u) ? le(l) ? f[c] = bt(l.text + u) : "" !== u && f.push(bt(u)) : le(u) && le(l) ? f[c] = bt(l.text + u.text) : (a(e._isVList) && o(u.tag) && i(u.key) && o(n) && (u.key = "__vlist" + n + "_" + r + "__"), f.push(u)));
					return f
				}(t) : void 0
			}
			...
			function Pe(t) {
				t._o = Se, t._n = h, t._s = p, t._l = ve, t._t = be, t._q = D, t._i = L, t._m = ke, t._f = _e, t._k = we, t._b = xe, t._v = bt, t._e = vt, t._u = Ae, t._g = Ee, t._d = Te, t._p = Oe
			}
			...
			function bn(t, e, n) {
				var r = !it();
				"function" == typeof n ? (mn.get = r ? _n(e) : yn(n), mn.set = P) : (mn.get = n.get ? r && !1 !== n.cache ? _n(e) : yn(n.get) : P, mn.set = n.set || P), Object.defineProperty(t, e, mn)
			}
			...
			Sn.prototype._init = function(t) {
					...
					e._uid = xn++, e._isVue = !0, t && t._isComponent ? function(t, e) {
						...
						}(e, t) : e.$options = Nt(kn(e.constructor), t || {}, e), e._renderProxy = e, e._self = e,
						function(t) {
							var e = t.$options,
								n = e.parent;
							if (n && !e.abstract) {
						...
						function(t) {
							...
							e.props && function(t, e) {
								...
								for (var i in e) {
									...
									r || (n[i] = new hn(t, a || P, P, vn)), i in t || bn(t, i, o)
								}
					...
					KeepAlive: {
						...
						render: function() {
							...
							if (n) {
								...
								a[u] ? (e.componentInstance = a[u].componentInstance, b(s, u), s.push(u)) : (a[u] = e, s.push(u), this.max && s.length > parseInt(this.max) && An(a, s[0], s, this._vnode)), e.data.keepAlive = !0
							}
							return e || t && t[0]
						}
					}
			...
			function hr(t, e, n) {
				t.tagName.indexOf("-") > -1 ? mr(t, e, n) : zn(e) ? Bn(n) ? t.removeAttribute(e) : (n = "allowfullscreen" === e && "EMBED" === t.tagName ? "true" : e, t.setAttribute(e, n)) : Dn(e) ? t.setAttribute(e, Nn(e, n)) : $n(e) ? Bn(n) ? t.removeAttributeNS(jn, Rn(e)) : t.setAttributeNS(jn, e, n) : mr(t, e, n)
			}
			...
			function Br(t, e) {
				var n = function(t) {
					if (t = t.trim(), br = t.length, t.indexOf("[") < 0 || t.lastIndexOf("]") < br - 1) return (wr = t.lastIndexOf(".")) > -1 ? {
						exp: t.slice(0, wr),
						key: '"' + t.slice(wr + 1) + '"'
					} : {
						exp: t,
					...
					for (_r = t, wr = xr = kr = 0; !Vr();) Hr(yr = qr()) ? Gr(yr) : 91 === yr && Ur(yr);
					return {
						exp: t.slice(0, xr),
						key: t.slice(xr + 1, kr)
					}
				...
				if (!i(r) && !o(n._enterCb) && 1 === n.nodeType) {
					...
					if (!E || w || "" === w) {
						...
						t.data.show || se(t, "insert", function() {
							...
							Mi(n, A), $.cancelled || (Pi(n, O), j || (Ri(L) ? setTimeout($, L) : Fi(n, s, $)))
				...
				if (!o(n._leaveCb)) {
					var a = r.css,
						...
						x = n._leaveCb = N(function() {
							n.parentNode && n.parentNode._pending && (n.parentNode._pending[t.key] = null), _ && (Mi(n, l), Mi(n, f)), x.cancelled ? (_ && Mi(n, c), g && g(n)) : (e(), m && m(n)), n._leaveCb = null
						});
					v ? v(k) : k()
				}

				function k() {
					x.cancelled || (!t.data.show && n.parentNode && ((n.parentNode._pending || (n.parentNode._pending = {}))[t.key] = t), d && d(n), _ && (Pi(n, c), Pi(n, f), Oi(function() {
				...
				function f(t, e, n, i, s, u, l) {
					if (o(t.elm) && o(u) && (t = u[l] = _t(t)), t.isRootInsert = !s, ! function(t, e, n, i) {
						...
						var f = t.data,
							m = t.children,
							g = t.tag;
						o(g) ? (t.elm = t.ns ? c.createElementNS(t.ns, g) : c.createElement(g, t), b(t), h(t, m, e), o(f) && v(t, e), p(n, t.elm, i)) : a(t.isComment) ? (t.elm = c.createComment(t.text), p(n, t.elm, i)) : (t.elm = c.createTextNode(t.text), p(n, t.elm, i))
					}
				}

				function d(t, e) {
					o(t.data.pendingInsert) && (e.push.apply(e, t.data.pendingInsert), t.data.pendingInsert = null), t.elm = t.componentInstance.$el, g(t) ? (v(t, e), b(t)) : (er(t), e.push(t))
				}
					...
					if (t !== e) {
						...
						if (a(t.isAsyncPlaceholder)) o(e.asyncFactory.resolved) ? E(t.elm, e, n) : e.isAsyncPlaceholder = !0;
							...
							i(e.text) ? o(m) && o(v) ? m !== v && function(t, e, n, r, a) {
								for (var s, u, l, d = 0, p = 0, h = e.length - 1, m = e[0], g = e[h], v = n.length - 1, b = n[0], y = n[v], x = !a; d <= h && p <= v;) i(m) ? m = e[++d] : i(g) ? g = e[--h] : ir(m, b) ? (S(m, b, r, n, p), m = e[++d], b = n[++p]) : ir(g, y) ? (S(g, y, r, n, v), g = e[--h], y = n[--v]) : ir(m, y) ? (S(m, y, r, n, v), x && c.insertBefore(t, m.elm, c.nextSibling(g.elm)), m = e[++d], y = n[--v]) : ir(g, b) ? (S(g, b, r, n, p), x && c.insertBefore(t, g.elm, m.elm), g = e[--h], b = n[++p]) : (i(s) && (s = or(e, d, h)), i(u = o(b.key) ? s[b.key] : k(b, e, d, h)) ? f(b, r, t, m.elm, !1, n, p) : ir(l = e[u], b) ? (S(l, b, r, n, p), e[u] = void 0, x && c.insertBefore(t, l.elm, m.elm)) : f(b, r, t, m.elm, !1, n, p), b = n[++p]);
								d > h ? _(t, i(n[v + 1]) ? null : n[v + 1].elm, n, p, v, r) : p > v && w(0, e, d, h)
							}(d, m, v, n, l) : o(v) ? (o(t.text) && c.setTextContent(d, ""), _(d, null, v, 0, v.length - 1, n)) : o(m) ? w(0, m, 0, m.length - 1) : o(t.text) && c.setTextContent(d, "") : t.text !== e.text && c.setTextContent(d, e.text), o(h) && o(p = h.hook) && o(p = p.postpatch) && p(t, e)
						}
					}
				}
			...
			function Gi(t, e, n) {
				...
				if (!i || Array.isArray(r)) {
					for (var o, a, s = 0, u = t.options.length; s < u; s++)
						if (a = t.options[s], i) o = L(r, Yi(a)) > -1, a.selected !== o && (a.selected = o);
			...
			function ca(t, e) {
				...
				! function(t) {
					var e = Nr(t, "key");
					e && (t.key = e)
				}(t), t.plain = !t.key && !t.scopedSlots && !t.attrsList.length, (r = Nr(n = t, "ref")) && (n.ref = r, n.refInFor = function(t) {
						for (var e = n; e;) {
					...
					function(t) {
						var e;
						(e = Nr(t, "is")) && (t.component = e), null != zr(t, "inline-template") && (t.inlineTemplate = !0)
					}(t);
				...
				return function(t) {
					...
					for (e = 0, n = c.length; e < n; e++)
						if (r = i = c[e].name, o = c[e].value, Ko.test(r))
							if (t.hasBindings = !0, (a = pa(r.replace(Ko, ""))) && (r = r.replace(na, "")), ea.test(r)) r = r.replace(ea, ""), o = Cr(o), (u = Qo.test(r)) && (r = r.slice(1, -1)), a && (a.prop && !u && "innerHtml" === (r = k(r)) && (r = "innerHTML"), a.camel && !u && (r = k(r)), a.sync && (s = Br(o, "$event"), u ? Lr(t, '"update:"+(' + r + ")", s, null, !1, 0, c[e], !0) : (Lr(t, "update:" + k(r), s, null, !1, 0, c[e]), C(r) !== k(r) && Lr(t, "update:" + C(r), s, null, !1, 0, c[e])))), a && a.prop || !t.component && Go(t.tag, t.attrsMap.type, r) ? Or(t, r, o, c[e], u) : Pr(t, r, o, c[e], u);
							else if (Yo.test(r)) r = r.replace(Yo, ""), (u = Qo.test(r)) && (r = r.slice(1, -1)), Lr(t, r, o, a, !1, 0, c[e], u);
					else {
					...
					directives: {
						model: function(t, e, n) {
							...
							if ("select" === o) ! function(t, e, n) {
								...
								Lr(t, "change", r = r + " " + Br(e, "$event.target.multiple ? $$selectedVal : $$selectedVal[0]"), null, !0)
							}(t, r);
								...
								Or(t, "checked", "Array.isArray(" + e + ")?_i(" + e + "," + i + ")>-1" + ("true" === o ? ":(" + e + ")" : ":_q(" + e + "," + o + ")")), Lr(t, "change", "var $$a=" + e + ",$$el=$event.target,$$c=$$el.checked?(" + o + "):(" + a + ");if(Array.isArray($$a)){var $$v=" + (r ? "_n(" + i + ")" : i) + ",$$i=_i($$a,$$v);if($$el.checked){$$i<0&&(" + Br(e, "$$a.concat([$$v])") + ")}else{$$i>-1&&(" + Br(e, "$$a.slice(0,$$i).concat($$a.slice($$i+1))") + ")}}else{" + Br(e, "$$c") + "}", null, !0)
							}(t, r, i);
							else if ("input" === o && "radio" === a) ! function(t, e, n) {
								var r = n && n.number,
									i = Nr(t, "value") || "null";
								Or(t, "checked", "_q(" + e + "," + (i = r ? "_n(" + i + ")" : i) + ")"), Lr(t, "change", Br(e, i), null, !0)
							}(t, r, i);
								...
								var f = Br(e, l);
								u && (f = "if($event.target.composing)return;" + f), Or(t, "value", "(" + e + ")"), Lr(t, c, f, null, !0), (s || a) && Lr(t, "blur", "$forceUpdate()")
							}(t, r, i);
			...
			function ja(t, e, n, r) {
				return t.ifProcessed = !0,
					function t(e, n, r, i) {
						...
						function a(t) {
							return r ? r(t, n) : t.once ? za(t, n) : La(t, n)
						}
			...
			var Ka, Za, Ja = (Ka = function(t, e) {
							...
							for (var n, r, i = [], o = e.expectHTML, a = e.isUnaryTag || M, s = e.canBeLeftOpenTag || M, u = 0; t;) {
								if (n = t, r && Mo(r)) {
									...
									if (0 === p) {
										...
										if (v) {
											var b = u;
											k(v[0].length), C(v[1], b, u);
											continue
										}
										var _ = S();
										if (_) {
											I(_), jo(_.tagName, t) && k(1);
											continue
										}
									}
									var y = void 0,
					...
					!1 !== e.optimize && function(t, e) {
						t && (va = wa(e.staticKeys || ""), ba = e.isReservedTag || M, function t(e) {
							if (e.static = function(t) {
									return 2 !== t.type && (3 === t.type || !(!t.pre && (t.hasBindings || t.if || t.for || g(t.tag) || !ba(t.tag) || function(t) {
										for (; t.parent;) {
	...
	if (n(20)) {
		var r = n(50),
			...
			$t = function(t, e) {
				return jt(t, e = b(e, !0)) ? f(2, t[e]) : q(t, e)
			},
			Rt = function(t, e, n) {
				return !(jt(t, e = b(e, !0)) && w(n) && _(n, "value")) || _(n, "get") || _(n, "set") || n.configurable || _(n, "writable") && !n.writable || _(n, "enumerable") && !n.enumerable ? B(t, e, n) : (t[e] = n.value, t)
			};
		bt || (R.f = $t, $.f = Rt), a(a.S + a.F * !bt, "Object", {
		...
		p(Bt, zt), d(Bt, ht, zt.values), p(Bt, {
			...
			_ ? (h = n(function(t, n, r, i) {
				...
				var o, a, s, u, f = 0,
					p = 0;
				if (w(n)) {
					if (!(n instanceof W || "ArrayBuffer" == (u = y(n)) || "SharedArrayBuffer" == u)) return _t in n ? At(h, n) : Ot.call(h, n);
					o = n, p = St(r, e);
					var v = n.byteLength;
					if (void 0 === i) {
				...
				var o;
				return l(t, h, c), w(n) ? n instanceof W || "ArrayBuffer" == (o = y(n)) || "SharedArrayBuffer" == o ? void 0 !== i ? new v(n, St(r, e), i) : void 0 !== r ? new v(n, St(r, e)) : new v(n) : _t in n ? At(h, n) : Ot.call(h, n) : new v(g(n))
			}), K(b !== Function.prototype ? C(v).concat(C(b)) : C(v), function(t) {
				t in h || d(h, t, v[t])
			}), h.prototype = k, r || (k.constructor = h));
			var A = k[ht],
				T = !!A && ("values" == A.name || null == A.name),
				O = zt.values;
			d(h, gt, !0), d(k, _t, c), d(k, yt, !0), d(k, vt, h), (u ? new h(1)[mt] == c : mt in k) || B(k, mt, {
				get: function() {
					return c
				}
				...
				from: Ot,
				of : Pt
			}), "BYTES_PER_ELEMENT" in k || d(k, "BYTES_PER_ELEMENT", e), a(a.P, c, Dt), N(c), a(a.P + a.F * kt, c, {
				set: Nt
	...
	(e = t.exports = function(t, e, n, f, d) {
		...
		if (o(v)) {
			for (p = s(t.length); p > _; _++)
				if ((g = e ? b(a(h = t[_])[0], h[1]) : b(t[_])) === c || g === l) return g
		} else
			for (m = v.call(t); !(h = m.next()).done;)
				if ((g = i(m, b, h.value, e)) === c || g === l) return g
	}).BREAK = c, e.RETURN = l
}, function(t, e, n) {
	var r = n(9).navigator;
	...
	t.exports = function(t, e, n, m, g, v) {
		...
		if ("function" == typeof _ && (v || w.forEach && !f(function() {
				(new _).entries().next()
			}))) {
			var S = new _,
				I = S[y](v ? {} : -0, 1) != S,
			...
			})).prototype = w, w.constructor = _), (C || A) && (k("delete"), k("has"), g && k("get")), (A || I) && k(y), v && w.clear && delete w.clear
		} else _ = m.getConstructor(e, t, g, y), a(_.prototype, n), s.NEED = !0;
		return p(_, t), x[t] = _, i(i.G + i.W + i.F * (_ != b), x), v || m.setStrong(_, t, g), _
	}
}, function(t, e, n) {
	...
	if (a.ABV) {
		if (!c(function() {
			...
			for (var U, G = (y = function(t) {
				...
				})[b] = I[b], W = h(I), Y = 0; W.length > Y;)(U = W[Y++]) in y || s(y, U, I[U]);
			o || (G.constructor = y)
		}
		var K = new w(new y(2)),
			Z = w[b].setInt8;
		K.setInt8(0, 2147483648), K.setInt8(1, 2147483649), !K.getInt8(0) && K.getInt8(1) || u(w[b], {
	...
	}, i && (q(y, "byteLength", "_l"), q(w, "buffer", "_b"), q(w, "byteLength", "_l"), q(w, "byteOffset", "_o")), u(w[b], {
		getInt8: function(t) {
	...
	v(y, "ArrayBuffer"), v(w, "DataView"), s(w[b], a.VIEW, !0), e.ArrayBuffer = y, e.DataView = w
}, function(t, e) {
	var n = t.exports = "undefined" != typeof window && window.Math == Math ? window : "undefined" != typeof self && self.Math == Math ? self : Function("return this")();
	"number" == typeof __g && (__g = n)
}, function(t, e) {
				...
				b(function() {
					for (var r = t._v, i = 1 == t._s, o = 0, a = function(e) {
							var n, o, a, s = i ? e.ok : e.fail,
								...
								l = e.domain;
							try {
								s ? (i || (2 == t._h && N(t), t._h = 1), !0 === s ? n = r : (l && l.enter(), n = s(r), l && (l.exit(), a = !0)), n === e.promise ? c(k("Promise-chain cycle")) : (o = M(n)) ? o.call(n, u, c) : u(n)) : c(r)
							} catch (t) {
								l && !a && l.exit(), c(t)
							}
						}; n.length > o;) a(n[o++]);
	...
	var r = n(9),
		...
		W = function(t, e, n) {
			return t === R && W($, e, n), b(t), e = w(e, !0), b(n), i(j, e) ? (n.enumerable ? (i(t, D) && t[D][e] && (t[D][e] = !1), n = k(n, {
				enumerable: x(0, !1)
	...
	a(a.S + a.F * !B, "Symbol", {
		...
		stringify: function(t) {
			...
			if (n = e = r[1], (_(e) || void 0 !== t) && !G(t)) return v(e) || (e = function(t, e) {
				if ("function" == typeof n && (e = n.call(this, t, e)), !G(e)) return e
			}), r[1] = e, F.apply(M, r)
		}
	}), P.prototype[L] || n(26)(P.prototype, L, P.prototype.valueOf), f(P, "Symbol"), f(Math, "Math", !0), f(r.JSON, "JSON", !0)
}, function(t, e, n) {
	...
	if (!p(" 0o1") || !p("0b1") || p("+0x1")) {
		...
		for (var _, y = n(20) ? c(h) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","), w = 0; y.length > w; w++) i(h, _ = y[w]) && !i(p, _) && f(p, _, l(h, _));
	...
	i(i.S + i.F * !n(81)(function(t) {
		...
		from: function(t) {
			var e, n, i, f, d = o(t),
				...
				v = 0,
				b = l(d);
			if (g && (m = r(m, h > 2 ? arguments[2] : void 0, 2)), null == b || p == Array && s(b))
				for (n = new p(e = u(d.length)); e > v; v++) c(n, v, g ? m(d[v], v) : d[v]);
			else
				for (f = b.call(d), n = new p; !(i = f.next()).done; v++) c(n, v, g ? a(f, m, [i.value, v], !0) : i.value);
			return n.length = v, n
		}
	})
}, function(t, e, n) {
	...
	n(84)("replace", 2, function(t, e, n, h) {
		return [function(r, i) {
			...
			for (var b = [];;) {
				...
				if (null === _) break;
				if (b.push(_), !g) break;
				"" === String(_[0]) && (f.lastIndex = s(d, o(f.lastIndex), v))
			}
			for (var y, w = "", x = 0, k = 0; k < b.length; k++) {
				_ = b[k];
				for (var S = String(_[0]), I = c(l(a(_.index), d.length), 0), C = [], E = 1; E < _.length; E++) C.push(void 0 === (y = _[E]) ? y : String(y));
				var A = _.groups;
				if (p) {
	...
	n(84)("split", 2, function(t, e, n, l) {
		...
		return h = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function(t, e) {
			...
			var c = i(t),
				...
				b = new m(p ? c : "^(?:" + c.source + ")", v),
				_ = void 0 === e ? 4294967295 : e >>> 0;
			if (0 === _) return [];
			if (0 === d.length) return null === u(b, d) ? [d] : [];
			for (var y = 0, w = 0, x = []; w < d.length;) {
				b.lastIndex = p ? w : 0;
				var k, S = u(b, p ? d : d.slice(w));
				if (null === S || (k = f(s(b.lastIndex + (p ? 0 : w)), d.length)) === y) w = a(d, w, g);
				else {
					if (x.push(d.slice(y, w)), x.length === _) return x;
					for (var I = 1; I <= S.length - 1; I++)
						if (x.push(S[I]), x.length === _) return x;
					w = y = k
				}
			}
	...
	var r, i = n(9),
		...
		_ = t.exports = n(87)("WeakMap", v, b, c, !0, !0);
	d && p && (u((r = c.getConstructor(v, "WeakMap")).prototype, b), s.NEED = !0, o(["delete", "has", "get", "set"], function(t) {
		var e = _.prototype,
			n = e[t];
		a(e, t, function(e, i) {
			if (l(e) && !m(e)) {
	...
	t.exports = function t(e, n, u, c, l, f, d, p) {
		for (var h, m, g = l, v = 0, b = !!d && a(d, p, 3); v < c;) {
			if (v in u) {
				if (h = b ? b(u[v], v, n) : u[v], m = !1, i(h) && (m = void 0 !== (m = h[s]) ? !!m : r(h)), m && f > 0) g = t(e, n, h, o(h.length), g, f - 1) - 1;
				else {
	...
	for (var r = n(134), i = n(51), o = n(22), a = n(9), s = n(26), u = n(60), c = n(13), l = c("iterator"), f = c("toStringTag"), d = u.Array, p = {
		...
		var g, v = h[m],
			...
			_ = a[v],
			y = _ && _.prototype;
		if (y && (y[l] || s(y, l, d), y[f] || s(y, f, v), u[v] = d, b))
	...
	var r = n(139),
		...
		u = function(t, e, n) {
			...
			for (c in p && (n = e), n)(l = !d && y && void 0 !== y[c]) && s(b, c) || (f = l ? y[c] : n[c], b[c] = p && "function" != typeof y[c] ? n[c] : g && l ? o(f, r) : v && y[c] == f ? function(t) {
			...
			}(f) : m && "function" == typeof f ? o(Function.call, f) : f, m && ((b.virtual || (b.virtual = {}))[c] = f, t & u.R && _ && !_[c] && a(_, c, f)))
		};
	...
	function _(t, e) {
		...
		e || r.isString(t) || (e = t || {}, t = "default"), this.inline = new u, this.block = new s, this.core = new a, this.renderer = new o, this.linkify = new c, this.validateLink = m, this.normalizeLink = v, this.normalizeLinkText = b, this.utils = r, this.helpers = r.assign({}, i), this.options = {}, this.configure(t), e && this.set(e)
	}
	...
	r.prototype.parse = function(t, e) {
		...
		if (v && (o = (v = v[0]).toLowerCase(), this.protocol = v, m = m.substr(v.length)), (e || v || m.match(/^\/\/[^@\/]+@[^@\/]+/)) && (!(u = "//" === m.substr(0, 2)) || v && p[v] || (m = m.substr(2), this.slashes = !0)), !p[v] && (u || v && !h[v])) {
			...
			for (-1 !== (_ = -1 === y ? m.lastIndexOf("@") : m.lastIndexOf("@", y)) && (b = m.slice(0, _), m = m.slice(_ + 1), this.auth = b), y = -1, n = 0; n < c.length; n++) - 1 !== (s = m.indexOf(c[n])) && (-1 === y || s < y) && (y = s); - 1 === y && (y = m.length), ":" === m[y - 1] && y--;
			var w = m.slice(0, y);
	...
	t.exports = function(t) {
		var e, n, o, a, s, u, c, l, f, d, p, h, m, g, v, b, _, y, w = t.tokens;
					...
					for (m = 0, e = (a = w[n].children).length - 1; e >= 0; e--)
						if ("link_close" !== (u = a[e]).type) {
							if ("html_inline" === u.type && (y = u.content, /^<a[>\s]/i.test(y) && m > 0 && m--, i(u.content) && m++), !(m > 0) && "text" === u.type && t.md.linkify.test(u.content)) {
								for (f = u.content, _ = t.md.linkify.match(f), c = [], h = u.level, p = 0, l = 0; l < _.length; l++) g = _[l].url, v = t.md.normalizeLink(g), t.md.validateLink(v) && (b = _[l].text, b = _[l].schema ? "mailto:" !== _[l].schema || /^mailto:/i.test(b) ? t.md.normalizeLinkText(b) : t.md.normalizeLinkText("mailto:" + b).replace(/^mailto:/, "") : t.md.normalizeLinkText("http://" + b).replace(/^http:\/\//, ""), (d = _[l].index) > p && ((s = new t.Token("text", "", 0)).content = f.slice(p, d), s.level = h, c.push(s)), (s = new t.Token("link_open", "a", 1)).attrs = [
									["href", v]
								], s.level = h++, s.markup = "linkify", s.info = "auto", c.push(s), (s = new t.Token("text", "", 0)).content = b, s.level = h, c.push(s), (s = new t.Token("link_close", "a", -1)).level = --h, s.markup = "linkify", s.info = "auto", c.push(s), p = _[l].lastIndex);
	...
	function l(t, e) {
		var n, a, l, f, d, p, h, m, g, v, b, _, y, w, x, k, S, I, C, E, A;
					...
					if (x = k = !0, d = f.index + 1, I = "'" === f[0], g = 32, f.index - 1 >= 0) g = l.charCodeAt(f.index - 1);
						...
						for (S = n + 1; S < t.length && "softbreak" !== t[S].type && "hardbreak" !== t[S].type; S++)
							if ("text" === t[S].type) {
								...
								break
							} if (b = o(g) || i(String.fromCharCode(g)), _ = o(v) || i(String.fromCharCode(v)), y = r(g), (w = r(v)) ? x = !1 : _ && (y || b || (x = !1)), y ? k = !1 : b && (w || _ || (k = !1)), 34 === v && '"' === f[0] && g >= 48 && g <= 57 && (k = x = !1), x && k && (x = !1, k = _), x || k) {
						if (k)
	...
	t.exports = function(t, e, n, a) {
		...
		for (h = t.push("tr_close", "tr", -1), h = t.push("thead_close", "thead", -1), (h = t.push("tbody_open", "tbody", 1)).map = b = [e + 2, 0], f = e + 2; f < n && !(t.sCount[f] < t.blkIndent) && -1 !== (u = i(t, f).trim()).indexOf("|") && !(t.sCount[f] - t.blkIndent >= 4); f++) {
	...
	var r = n(8).isSpace;
	t.exports = function(t, e, n, i) {
		var o, a, s, u, c, l, f, d, p, h, m, g, v, b, _, y, w, x, k, S, I = t.lineMax,
		...
		for (m = [t.bsCount[e]], t.bsCount[e] = t.sCount[e] + 1 + (y ? 1 : 0), l = C >= E, b = [t.sCount[e]], t.sCount[e] = p - u, _ = [t.tShift[e]], t.tShift[e] = C - t.bMarks[e], x = t.md.block.ruler.getRules("blockquote"), v = t.parentType, t.parentType = "blockquote", S = !1, d = e + 1; d < n && (t.sCount[d] < t.blkIndent && (S = !0), !((C = t.bMarks[d] + t.tShift[d]) >= (E = t.eMarks[d]))); d++)
			if (62 !== t.src.charCodeAt(C++) || S) {
				...
				if (w) {
					t.lineMax = d, 0 !== t.blkIndent && (h.push(t.bMarks[d]), m.push(t.bsCount[d]), _.push(t.tShift[d]), b.push(t.sCount[d]), t.sCount[d] -= t.blkIndent);
					break
				}
				h.push(t.bMarks[d]), m.push(t.bsCount[d]), _.push(t.tShift[d]), b.push(t.sCount[d]), t.sCount[d] = -1
			} else {
				...
				l = C >= E, m.push(t.bsCount[d]), t.bsCount[d] = t.sCount[d] + 1 + (y ? 1 : 0), b.push(t.sCount[d]), t.sCount[d] = p - u, _.push(t.tShift[d]), t.tShift[d] = C - t.bMarks[d]
			}
		for (g = t.blkIndent, t.blkIndent = 0, (k = t.push("blockquote_open", "blockquote", 1)).markup = ">", k.map = f = [e, 0], t.md.block.tokenize(t, e, d), (k = t.push("blockquote_close", "blockquote", -1)).markup = ">", t.lineMax = I, t.parentType = v, f[1] = t.line, s = 0; s < _.length; s++) t.bMarks[s + e] = h[s], t.tShift[s + e] = _[s], t.sCount[s + e] = b[s], t.bsCount[s + e] = m[s];
	...
	t.exports = function(t, e, n, r) {
		var a, s, u, c, l, f, d, p, h, m, g, v, b, _, y, w, x, k, S, I, C, E, A, T, O, P, M, F, D = !1,
			L = !0;
		if (t.sCount[e] - t.blkIndent >= 4) return !1;
		if (r && "paragraph" === t.parentType && t.tShift[e] >= t.blkIndent && (D = !0), (A = o(t, e)) >= 0) {
			if (d = !0, O = t.bMarks[e] + t.tShift[e], b = Number(t.src.substr(O, A - O - 1)), D && 1 !== b) return !1
		} else {
		...
		for (g = t.tokens.length, d ? (F = t.push("ordered_list_open", "ol", 1), 1 !== b && (F.attrs = [
				["start", b]
			...
			for (E = A, _ = t.eMarks[y], f = w = t.sCount[y] + A - (t.bMarks[e] + t.tShift[e]); E < _;) {
		...
		return (F = d ? t.push("ordered_list_close", "ol", -1) : t.push("bullet_list_close", "ul", -1)).markup = String.fromCharCode(v), m[1] = y, t.line = y, t.parentType = S, L && function(t, e) {
			var n, r, i = t.level + 2;
	...
	t.exports = function(t, e, n, o) {
		var a, s, u, c, l, f, d, p, h, m, g, v, b, _, y, w, x = 0,
		...
		for (S = (b = t.getLines(e, I, t.blkIndent, !1).trim()).length, k = 1; k < S; k++) {
			if (91 === (a = b.charCodeAt(k))) return !1;
			if (93 === a) {
				h = k;
				break
			}
			10 === a ? x++ : 92 === a && ++k < S && 10 === b.charCodeAt(k) && x++
		}
		if (h < 0 || 58 !== b.charCodeAt(h + 1)) return !1;
		for (k = h + 2; k < S; k++)
			if (10 === (a = b.charCodeAt(k))) x++;
			else if (!i(a)) break;
		if (!(g = t.md.helpers.parseLinkDestination(b, k, S)).ok) return !1;
		if (l = t.md.normalizeLink(g.str), !t.md.validateLink(l)) return !1;
		for (s = k = g.pos, u = x += g.lines, v = k; k < S; k++)
			if (10 === (a = b.charCodeAt(k))) x++;
			else if (!i(a)) break;
		for (g = t.md.helpers.parseLinkTitle(b, k, S), k < S && v !== k && g.ok ? (w = g.str, k = g.pos, x += g.lines) : (w = "", k = s, x = u); k < S && (a = b.charCodeAt(k), i(a));) k++;
		if (k < S && 10 !== b.charCodeAt(k) && w)
			for (w = "", k = s, x = u; k < S && (a = b.charCodeAt(k), i(a));) k++;
		return !(k < S && 10 !== b.charCodeAt(k) || !(p = r(b.slice(1, h))) || !o && (void 0 === t.env.references && (t.env.references = {}), void 0 === t.env.references[p] && (t.env.references[p] = {
			title: w,
			href: l
	...
	t.exports = function(t, e) {
		...
		if ((l = u + 1) < _ && 40 === t.src.charCodeAt(l)) {
			for (l++; l < _ && (o = t.src.charCodeAt(l), i(o) || 10 === o); l++);
			if (l >= _) return !1;
			for (g = l, (d = t.md.helpers.parseLinkDestination(t.src, l, t.posMax)).ok && (v = t.md.normalizeLink(d.str), t.md.validateLink(v) ? l = d.pos : v = ""), g = l; l < _ && (o = t.src.charCodeAt(l), i(o) || 10 === o); l++);
			if (d = t.md.helpers.parseLinkTitle(t.src, l, t.posMax), l < _ && g !== l && d.ok)
				for (p = d.str, l = d.pos; l < _ && (o = t.src.charCodeAt(l), i(o) || 10 === o); l++);
			else p = "";
			if (l >= _ || 41 !== t.src.charCodeAt(l)) return t.pos = b, !1;
			l++
		} else {
			if (void 0 === t.env.references) return !1;
			if (l < _ && 91 === t.src.charCodeAt(l) ? (g = l + 1, (l = t.md.helpers.parseLinkLabel(t, l)) >= 0 ? s = t.src.slice(g, l++) : l = u + 1) : l = u + 1, s || (s = t.src.slice(c, u)), !(f = t.env.references[r(s)])) return t.pos = b, !1;
			v = f.href, p = f.title
		}
		return e || (a = t.src.slice(c, u), t.md.inline.parse(a, t.md, t.env, m = []), (h = t.push("image", "img", 0)).attrs = n = [
			["src", v],
			["alt", ""]
		], h.children = m, h.content = a, p && n.push(["title", p])), t.pos = l, t.posMax = _, !0
	}
}, function(t, e, n) {
	"use strict";
	...
	s.prototype.pushPending = function() {
		...
		for (n = t > 0 ? this.src.charCodeAt(t - 1) : 32; h < v && this.src.charCodeAt(h) === b;) h++;
	...
	(function(t, r) {
		...
		! function(o) {
			...
			function C(t, e) {
				var n = t.split("@"),
					r = "";
				return n.length > 1 && (r = n[0] + "@", t = n[1]), r + I((t = t.replace(_, ".")).split("."), e).join(".")
			}
			...
			function P(t) {
				var e, n, r, i, o, a, s, d, p, v, b, _ = [],
					y = t.length,
					w = 0,
					k = m,
					I = h;
				for ((n = t.lastIndexOf(g)) < 0 && (n = 0), r = 0; r < n; ++r) t.charCodeAt(r) >= 128 && S("not-basic"), _.push(t.charCodeAt(r));
				for (i = n > 0 ? n + 1 : 0; i < y;) {
					for (o = w, a = 1, s = c; i >= y && S("invalid-input"), ((d = (b = t.charCodeAt(i++)) - 48 < 10 ? b - 22 : b - 65 < 26 ? b - 65 : b - 97 < 26 ? b - 97 : c) >= c || d > x((u - w) / a)) && S("overflow"), w += d * a, !(d < (p = s <= I ? l : s >= I + f ? f : s - I)); s += c) a > x(u / (v = c - p)) && S("overflow"), a *= v;
					I = O(w - o, e = _.length + 1, 0 == o), x(w / e) > u - k && S("overflow"), k += x(w / e), w %= e, _.splice(w++, 0, k)
				}
				return A(_)
			}

			function M(t) {
				var e, n, r, i, o, a, s, d, p, v, b, _, y, w, I, C = [];
				for (_ = (t = E(t)).length, e = m, n = 0, o = h, a = 0; a < _; ++a)(b = t[a]) < 128 && C.push(k(b));
				for (r = i = C.length, i && C.push(g); r < _;) {
					for (s = u, a = 0; a < _; ++a)(b = t[a]) >= e && b < s && (s = b);
					for (s - e > x((u - n) / (y = r + 1)) && S("overflow"), n += (s - e) * y, e = s, a = 0; a < _; ++a)
						if ((b = t[a]) < e && ++n > u && S("overflow"), b == e) {
	...
	}, _.state.set = function(t) {}, b.prototype.commit = function(t, e, n) {
		var r = this,
			i = I(t, e, n),
			o = i.type,
			a = i.payload,
	...
	var K = {
		...
		Z = (n(381), n(4)),
		J = Object(Z.a)(K, N, [], !1, null, "1da607ae", null);
	...
	var X = J.exports,
		...
		Tt = {
			...
			methods: s()({}, O(["setIndex"]), {
				...
				getSpriteStyle: function(t) {
					return t.height > t.width ? `${t.style}; height: ${t.height}px; width: ${t.width}px; transform: scale(${144/t.height}); position: absolute;` : `${t.style}; height: ${t.height}px; width: ${t.width}px; transform: scale(${100/t.width}); position: absolute;`
				}
			})
		},
		Ot = (n(383), Object(Z.a)(Tt, L, [], !1, null, "9a3a9f7e", null));
	...
	var Ft = function() {
		...
		return n("div", {
			...
			return n("div", {
				...
				style: {
					width: t.widthScale + "%",
					"padding-bottom": t.widthScale * (e.preciseHeightOfWidth ? e.preciseHeightOfWidth : e.heightOfWidth) + "%",
				...
				on: {
					"update-img-page-info": t.updateImgPageInfo
				}
			})], 1)
	...
	var zt = {
		...
		jt = (n(385), Object(Z.a)(zt, Nt, [], !1, null, "bf2caa1e", null));
	...
	var $t = jt.exports,
		...
		Bt = (n(387), Object(Z.a)(Rt, Lt, [], !1, null, "47291428", null));
	...
	var Te, Oe, Pe = {
		...
		Fe = {
			...
			parseFailed: {
				cn: '解析錯誤, 可能是因為 Thumbnail Settings 不是`"Normal"`或`"Small"`, 可前往 Settings 頁面修改配置後重試。詳細錯誤如下:',
		...
		$e = "\nYou can use the keyboard's `A`, `D`, `Left`, `Right` and `Space` keys or mouse wheel to page. \n",
		Re = "\n* 修覆exhentai/ehentai的頁數解析問題\n* 現已支持大圖縮略圖\n\n### iPad支持\n* 目前在iOS 15/iPadOS 15上可以運行油猴腳本了，因此eHunter也能成功在iPad上使用\n* 目前沒有在UI上做移動端適配，因此比較適合iPad使用，看看大家的需求再決定要不要對iPhone做UI優化\n* 使用指南: [鏈接](https://github.com/hanFengSan/eHunter/blob/master/ipad_cn.md)\n\n### eHunter-local\neHunter-local是eHunter的本地版本, 支持Windows和MacOS. [項目主頁](https://github.com/hanFengSan/eHunter_local)\n\n[Github下載](https://github.com/hanFengSan/eHunter_local/releases) [百度網盤](https://pan.baidu.com/s/1wEnBe9uGoBKzNd4DCfbuAg) 提取碼: czft\n\n",
		...
		Ve = new(function() {
			...
			return t.prototype.initString = function() {
				...
				this.cn.p_instruction = De, this.en.p_instruction = Le, this.jp.p_instruction = Ne, this.cn.p_bookInstruction = ze, this.en.p_bookInstruction = je, this.jp.p_bookInstruction = $e, this.cn.p_version = Re, this.en.p_version = Be, this.jp.p_version = qe
			}, t
		}()),
		He = {
			state: {
	...
	var Ke = new D.Store({
        ...
        // =================================================================================
        // START: 在這裡貼上新的 SettingService 程式碼 (修復版)
        // =================================================================================

        Xe = new(function() {
            // --- 定義異步輔助函數 (確保它們在當前作用域可用) ---
            ...
            t.prototype.getCurrentHost = function() {
                return window.location.hostname;
            };

            t.prototype._getDefaultSettings = function() {
                return {
                    ...
                    lang: { eventName: "setString", val: ht },
                    updateTime: { val: 0 },
                    firstOpen: { val: !0 },
                    ...
                    oddEven: { eventName: "setOddEven", val: !1 }
                }
            };
            ...
            t.prototype._migrate = function() {
                return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(i) {
                        switch (i.label) {
                            case 0: return [4, Me.load({ key: this.storageVersionName })];
                            case 1: return t = i.sent(), [4, Me.save({ key: this.storageVersionName, data: this.version })];
                            case 2: return i.sent(), t === this.version ? [3, 5] : [4, Me.load({ key: this.storageName })];
                            case 3:
                                e = i.sent();
                                // 檢查是否需要遷移舊資料結構
                                if (e && !e["www.wnacg.com"] && !e["e-hentai.org"] && !e["exhentai.org"] && !e["nhentai.net"]) {
                                    console.log("--- EHUNTER MIGRATION --- Migrating old settings to host-based structure.");
                                    var newSettings = {};
                                    ["www.wnacg.com", "e-hentai.org", "exhentai.org", "nhentai.net"].forEach(host => {
                                        newSettings[host] = JSON.parse(JSON.stringify(this._getDefaultSettings()));
                                        for(var key in e) {
                                            if(newSettings[host][key] && e[key]) {
                                                newSettings[host][key].val = e[key].val;
                                            }
                                        }
                                    });
                                    return [4, Me.save({ key: this.storageName, data: newSettings })];
                                }
                                return [3, 5];
            ...
            t.prototype._setSettingItem = function(settingKey, value) {
                return __awaiter(this, void 0, void 0, function() {
                    var host, allSettings, defaultSettings;
                    return __generator(this, function(e) {
                        switch (e.label) {
                            case 0:
                                host = this.getCurrentHost();
                                return [4, Me.load({ key: this.storageName })];
                            case 1:
                                allSettings = e.sent() || {};
                                if (!allSettings[host]) {
                                    allSettings[host] = JSON.parse(JSON.stringify(this._getDefaultSettings()));
                                }
                                // 確保設定項存在 (防止新版本增加設定項時出錯)
                                if (!allSettings[host].hasOwnProperty(settingKey)) {
                                    defaultSettings = this._getDefaultSettings();
                                    allSettings[host][settingKey] = defaultSettings[settingKey] ? JSON.parse(JSON.stringify(defaultSettings[settingKey])) : { val: value };
                                }
                                allSettings[host][settingKey].val = value;
                                return [4, Me.save({ key: this.storageName, data: allSettings })];
                            case 2:
                                return e.sent(),
                                    allSettings[host][settingKey].eventName && Ke.dispatch(allSettings[host][settingKey].eventName, value),
                                    [2]
                        }
                    })
                })
            ...
            t.prototype._getSettingItem = function(settingKey) {
                return __awaiter(this, void 0, void 0, function() {
                    var host, allSettings, hostSettings;
                    return __generator(this, function(e) {
                        switch (e.label) {
                            case 0:
                                host = this.getCurrentHost();
                            ...
                            case 1:
                                allSettings = e.sent() || {};
                                hostSettings = allSettings[host];
                                if (!hostSettings || !hostSettings.hasOwnProperty(settingKey)) {
                                    return [2, this._getDefaultSettings()[settingKey].val];
                                }
                                return [2, hostSettings[settingKey].val];
                        }
                    })
                })
            };
            ...
            t.prototype.initSettings = function() {
                return __awaiter(this, void 0, void 0, function() {
                    var host, allSettings, hostSettings, defaultSettings, settingKey;
                    return __generator(this, function(e) {
                        switch (e.label) {
                            case 0:
                                host = this.getCurrentHost();
                            ...
                            case 1:
                                ...
                                hostSettings = allSettings[host];
                                if (!hostSettings) {
                                    hostSettings = JSON.parse(JSON.stringify(this._getDefaultSettings()));
                                    allSettings[host] = hostSettings;
                                    Me.save({ key: this.storageName, data: allSettings });
                                } else {
                                    defaultSettings = this._getDefaultSettings();
                                    for (var key in defaultSettings) {
                                        if (!hostSettings.hasOwnProperty(key)) {
                                            hostSettings[key] = JSON.parse(JSON.stringify(defaultSettings[key]));
                                        }
                                    }
                                }
                                for (settingKey in hostSettings) {
                                    if (hostSettings[settingKey] && hostSettings[settingKey].eventName) {
                                        Ke.dispatch(hostSettings[settingKey].eventName, hostSettings[settingKey].val);
                                    }
                                }
                                return [2]
                        }
            ...
            // --- 所有的 set/get 方法 (保持不變) ---
            t.prototype.setAlbumWidth = function(t) { return this._setSettingItem("albumWidth", t) };
            t.prototype.getAlbumWidth = function() { return this._getSettingItem("albumWidth") };
            t.prototype.toggleEHunter = function(t) { return this._setSettingItem("toggleEHunter", t) };
            t.prototype.getEHunterStatus = function() { return this._getSettingItem("toggleEHunter") };
            t.prototype.toggleThumbView = function(t) { return this._setSettingItem("toggleThumbView", t) };
            t.prototype.getThumbViewStatus = function() { return this._getSettingItem("toggleThumbView") };
            t.prototype.setLoadNum = function(t) { return this._setSettingItem("loadNum", t) };
            t.prototype.getLoadNum = function() { return this._getSettingItem("loadNum") };
            t.prototype.setVolumeSize = function(t) { return this._setSettingItem("volumeSize", t) };
            t.prototype.getVolumeSize = function() { return this._getSettingItem("volumeSize") };
            t.prototype.setBookScreenAnimation = function(t) { return this._setSettingItem("showBookScreenAnimation", t) };
            t.prototype.getBookScreenAnimation = function() { return this._getSettingItem("showBookScreenAnimation") };
            t.prototype.setBookPagination = function(t) { return this._setSettingItem("showBookPagination", t) };
            t.prototype.getBookPagination = function() { return this._getSettingItem("showBookPagination") };
            t.prototype.setReadingMode = function(t) { return this._setSettingItem("readingMode", t) };
            t.prototype.getReadingMode = function() { return this._getSettingItem("readingMode") };
            t.prototype.setBookDirection = function(t) { return this._setSettingItem("bookDirection", t) };
            t.prototype.getBookDirection = function() { return this._getSettingItem("bookDirection") };
            t.prototype.setBookScreenSize = function(t) { return this._setSettingItem("bookScreenSize", t) };
            t.prototype.getBookScreenSize = function() { return this._getSettingItem("bookScreenSize") };
            t.prototype.setLang = function(t) { return this._setSettingItem("lang", t) };
            t.prototype.getLang = function() { return this._getSettingItem("lang") };
            t.prototype.setUpdateTime = function(t) { return this._setSettingItem("updateTime", t) };
            t.prototype.getUpdateTime = function() { return this._getSettingItem("updateTime") };
            t.prototype.setFirstOpen = function(t) { return this._setSettingItem("firstOpen", t) };
            t.prototype.getFirstOpen = function() { return this._getSettingItem("firstOpen") };
            t.prototype.setFirstOpenBookMode = function(t) { return this._setSettingItem("firstOpenBookMode", t) };
            t.prototype.getFirstOpenBookMode = function() { return this._getSettingItem("firstOpenBookMode") };
            t.prototype.setShowTopBar = function(t) { return this._setSettingItem("showTopBar", t) };
            t.prototype.getShowTopBar = function() { return this._getSettingItem("showTopBar") };
            t.prototype.setNormalMode = function(t) { return this._setSettingItem("isNormalMode", t) };
            t.prototype.getNormalMode = function() { return this._getSettingItem("isNormalMode") };
            t.prototype.setVersion = function(t) { return this._setSettingItem("version", t) };
            t.prototype.getVersion = function() { return this._getSettingItem("version") };
            t.prototype.setShowMoreSettings = function(t) { return this._setSettingItem("showMoreSettings", t) };
            t.prototype.getShowMoreSettings = function() { return this._getSettingItem("showMoreSettings") };
            t.prototype.setReverseFlip = function(t) { return this._setSettingItem("reverseFlip", t) };
            t.prototype.getReverseFlip = function() { return this._getSettingItem("reverseFlip") };
            t.prototype.setAutoFlipFrequency = function(t) { return this._setSettingItem("autoFlipFrequency", t) };
            t.prototype.getAutoFlipFrequency = function() { return this._getSettingItem("autoFlipFrequency") };
            t.prototype.setShowThumbViewInBook = function(t) { return this._setSettingItem("showThumbViewInBook", t) };
            t.prototype.getShowThumbViewInBook = function() { return this._getSettingItem("showThumbViewInBook") };
            t.prototype.setWheelSensitivity = function(t) { return this._setSettingItem("wheelSensitivity", t) };
            t.prototype.getWheelSensitivity = function() { return this._getSettingItem("wheelSensitivity") };
            t.prototype.setWheelDirection = function(t) { return this._setSettingItem("wheelDirection", t) };
            t.prototype.getWheelDirection = function() { return this._getSettingItem("wheelDirection") };
            t.prototype.setScrolledPageMargin = function(t) { return this._setSettingItem("scrolledPageMargin", t) };
            t.prototype.getScrolledPageMargin = function() { return this._getSettingItem("scrolledPageMargin") };
            t.prototype.setOddEven = function(t) { return this._setSettingItem("oddEven", t) };
            t.prototype.getOddEven = function() { return this._getSettingItem("oddEven") };

            return t;
        }()),

        // =================================================================================
        // END: 新的 SettingService 程式碼結束
        // =================================================================================
		Qe = function() {
			function t(t, e, n) {
				...
				return en(this, void 0, void 0, function() {
					...
					return nn(this, function(i) {
						switch (i.label) {
							...
							case 1:
								return n = i.sent(), Promise.race([new Qe(t.updateServer1, !0, !1).setCredentials("omit").request(), new Qe(t.updateServer2, !0, !1).setCredentials("omit").request()]).then(function(i) {
					...
					var t = this,
						...
						o = n({
							...
							change: function(newValue) {
								var currentPage = Ke.getters.curIndex.val;
								Xe.setAlbumWidth(newValue);
								setTimeout(() => {
									Ke.dispatch("setIndex", { val: currentPage, updater: 'WIDTH_CHANGE' });
								}, 350); //等350毫秒
							}
							//改
						}),
	...
	var mn = function(t) {
		...
		gn = {
			...
			created: function() {
				var t = f()(c.a.mark(function t() {
					return c.a.wrap(function(t) {
						for (;;) switch (t.prev = t.next) {
							case 0:
								this.imgPageInfo = JSON.parse(JSON.stringify(this.data)), this.imgPageInfo.isFirstLoad = !0, this.curLoadStatus = vt, this.active && this.getImgSrc();
							case 4:
							case "end":
								return t.stop()
						}
			...
			mounted: function() {
				var t = f()(c.a.mark(function t() {
					...
					return c.a.wrap(function(t) {
						for (;;) switch (t.prev = t.next) {
							case 0:
								e = this.$refs.page, (n = function() {
									var t = f()(c.a.mark(function t() {
										var n, i, o;
										return c.a.wrap(function(t) {
											for (;;) switch (t.prev = t.next) {
												case 0:
													return n = e.offsetWidth, i = e.offsetHeight, t.next = 4, r.service.album.getThumbInfo(r.index);
												case 4:
													return o = t.sent, t.next = 7, r.service.album.getPreviewThumbnailStyle(r.index, r.imgPageInfo, o, n, i);
												case 7:
													r.previewStyle = t.sent;
												case 8:
												case "end":
													return t.stop()
											}
			...
			methods: {
						...
						return c.a.wrap(function(t) {
							for (;;) switch (t.prev = t.next) {
								...
								case 3:
									...
									return console.Error("getImgSrc", e), t.abrupt("return");
								case 7:
									this.imgPageInfo.src !== e.src && (this.imgPageInfo = e, this.$emit("update-img-page-info", this.index, e)), this.curLoadStatus = bt;
								case 9:
								case "end":
									return t.stop()
							}
				...
				getNewImgSrc: function() {
					var t = f()(c.a.mark(function t(e) {
						...
						return c.a.wrap(function(t) {
							for (;;) switch (t.prev = t.next) {
								case 0:
									return this.reloadTimes++, this.message = "", this.imgPageInfo.src = "", this.curLoadStatus = bt, t.next = 6, this.service.album.getNewImgSrc(this.index, e);
								case 6:
								...
								case 12:
									this.imgPageInfo = n, this.$emit("update-img-page-info", this.index, n), t.next = 22;
									break;
								case 16:
									t.t0 = n.message, t.next = t.t0 === ut ? 19 : 21;
									break;
								case 19:
									return this.message = this.string.noOriginalImg, t.abrupt("break", 22);
								case 21:
				...
				failLoad: function(t) {
					t.preventDefault(), this.imgPageInfo.src && (this.curLoadStatus = _t, Ce.logText("LOADING", "loading image failed"), this.imgPageInfo.isFirstLoad && (this.imgPageInfo.isFirstLoad = !1, Ce.logText("LOADING", "reloading image"), this.getNewImgSrc(ot)))
				},
				loaded: function() {
	...
	var bn = vn.exports,
		_n = {
			...
			methods: s()({}, O(["setIndex", "toggleTopBar"]), {
				...
				updateImgPageInfo: function(t, e) {
					this.$set(this.imgPageInfos, t, e)
				}
			})
		},
		yn = (n(405), Object(Z.a)(_n, Ft, [], !1, null, "6de5fd1a", null));
						...
						for (var o, a = function() {
								var n, r = o.value,
									i = r.reduce(function(t, e) {
										var n = e.imgPageInfo.preciseHeightOfWidth ? e.imgPageInfo.preciseHeightOfWidth : e.imgPageInfo.heightOfWidth;
										return n > t ? n : t
									}, 0),
									a = i / r.length;
								n = a >= t.screenSize.screenRatio ? t.screenSize.height / i : t.screenSize.width / r.length, r.forEach(function(t) {
									var r = t.imgPageInfo.preciseHeightOfWidth ? t.imgPageInfo.preciseHeightOfWidth : t.imgPageInfo.heightOfWidth;
									e.push({
										id: t.id,
										height: n * r,
										width: n
	...
	var Dn = n(187),
			...
			var t = {
					...
					parse: function(e, r) {
						return r && "function" != typeof r || (r = {
							...
							for (var r, i, o, s, c, f, d, p, h, m, g, v, b, _ = function t(e, n) {
								...
								for (o = !1, s = document.createDocumentFragment(), f = (c = _[y]).nodeValue, p = 0; d = n.exec(f);) {
									if ((h = d.index) !== p && s.appendChild(u(f.slice(p, h), !0)), v = l(g = d[0]), p = h + g.length, b = e.callback(v, e), v && b) {
										...
										m.className = e.className, m.alt = g, m.src = b, o = !0, s.appendChild(m)
									}
		...
		$n = new(function() {
			function t() {
				de()(this, t), this.md = new Ln.a, this.md.use(zn.a, []);
	...
	var Xn = {
		...
		Qn = function() {
			...
			return t.prototype._initI2Element = function() {
			...
			}, t.prototype.getPreciseHeightOfWidth = function() {
				...
				var t = this.html.querySelector("#i6").children;
				return t[t.length - 1].children[1].getAttribute("href")
	...
	var or, ar = function() {
			...
			return t.prototype.getImgUrls = function() {
				return this._isValidIntroPage() ? 0 == this.html.querySelectorAll("#gdt>.gdtm").length ? Array.prototype.slice.call(this.html.querySelector("#gdt").children).map(function(t) {
					t.innerHTML.match(/width:(.*?)px;height:(.*?)px;/g);
					var e = Number(RegExp.$2),
						n = Number(RegExp.$1),
						r = t.getAttribute("href").match(/\/s.*$/) + "",
						i = t.innerHTML.match(/background:transparent\s+url\(([^)]+)\)\s*([-0-9px\s]+)no-repeat/);
					return {
						id: r,
						index: 0,
						pageUrl: r,
						...
						thumbWidth: n,
						heightOfWidth: e / n,
						thumbStyle: "background:transparent url(" + i[1] + ") " + i[2] + " no-repeat"
					}
				}) : Array.prototype.slice.call(this.html.getElementsByClassName("gdtm"), 0).map(function(t) {
				...
				var t = this.html.querySelector("#gdt").children[0].innerHTML.match(/url\(https.*?\)/g)[0].replace("url(", "").replace(")", "");
				return t.replace(t.match(/[0-9-]{3,20}\./)[0], "__PLACE_HOLDER__")
			}, t.prototype._getThumbPageCount = function(t) {
				if (t < 20) return 1;
				var e = t % 20;
				return e > 1 ? (t - e) / 20 + 1 : t / 20
			}, t.prototype._getThumbImgList = function(t, e) {
				for (var n = this._getThumbKeyId(), r = [], i = 0; i < this._getThumbPageCount(e); i++)
					if (n.includes("__PLACE_HOLDER__")) {
						var o = n.replace("__PLACE_HOLDER__", t + "-" + (i < 10 ? "0" + i : i) + ".");
						r.push(o)
					} else r.push(n + "/" + t + "-" + (i < 10 ? "0" + i : i) + ".jpg");
				return r
				...
				return n
			}, t.prototype.getMaxPageNumber = function() {
				var t = 0;
				return this.html.querySelectorAll("body>.gtb .ptb td a").forEach(function(e) {
					var n = parseInt(e.textContent, 10);
					!isNaN(n) && n > t && (t = n)
				}), t
			}, t
		}(),
			...
			return t.prototype.request = function() {
				return sr(this, void 0, void 0, function() {
					...
					return ur(this, function(e) {
						switch (e.label) {
							case 0:
								return [4, new ir([this.introUrl]).request()];
							case 1:
								return t = e.sent(), this.sumOfIntroPage = new ar(t.get(this.introUrl), this.introUrl).getMaxPageNumber(), this.introPageUrls = this._getIntroPageUrls(), [4, this._request()];
							case 2:
								return [2, e.sent()]
						}
					})
				...
				return sr(this, void 0, void 0, function() {
					...
					return ur(this, function(r) {
						switch (r.label) {
							case 0:
								return [4, new ir(this.introPageUrls).request()];
							case 1:
								return t = r.sent(), e = this.introPageUrls.reduce(function(e, n) {
									return e.concat(new ar(t.get(n), n).getImgUrls())
								}, []), n = 0, e.forEach(function(t) {
									t.index = n++
								}), [2, e]
						}
					})
			...
			return t.prototype._migrate = function() {
				...
				return fr(this, void 0, void 0, function() {
					return dr(this, function(t) {
						return this._album ? [2, this._album] : (this._album = {
							title: "",
							thumbInfos: [],
							imgPageInfos: []
						}, [2, this._album])
				...
				return fr(this, void 0, void 0, function() {
					return dr(this, function(r) {
						switch (r.label) {
							case 0:
								return [4, this.getImgPageInfos(t, e, n)];
							case 1:
				...
				return fr(this, void 0, void 0, function() {
					...
					return dr(this, function(o) {
						switch (o.label) {
							...
							case 1:
								return (r = o.sent()).imgPageInfos.length > 0 ? (Ce.logText("CacheService", "read imgPageInfos from cache"), [2, JSON.parse(JSON.stringify(r.imgPageInfos))]) : [3, 2];
							case 2:
								return o.trys.push([2, 4, , 5]), [4, this._getImgPageInfos(t, e, n)];
							case 3:
								return [2, o.sent()];
							case 4:
								return i = o.sent(), Ce.logText("CacheService", "loading ImgPageInfos failed. error: " + i), [2, []];
							case 5:
								return [2]
						}
					})
					...
					return dr(this, function(o) {
						switch (o.label) {
							case 0:
								return [4, this._getAlbum(t)];
							case 1:
								return r = o.sent(), [4, new cr(e, n).request()];
							case 2:
					...
					return dr(this, function(l) {
						switch (l.label) {
							case 0:
								return [4, this._getAlbum(t)];
							case 1:
								if ((i = l.sent()).imgPageInfos[e].src) return [2, lr({}, i.imgPageInfos[e])];
								l.label = 2;
							case 2:
							...
							case 9:
								return i.imgPageInfos[e].preciseHeightOfWidth = u.getPreciseHeightOfWidth(), [4, this._saveAlbum(t)];
							case 10:
								return l.sent(), [2, lr({}, i.imgPageInfos[e])];
							case 11:
								return c = l.sent(), console.error(c), [2, new Error(_t)];
							case 12:
								return [2]
						}
					})
		...
		mr = (or = function(t, e) {
			...
			or(t, e), t.prototype = null === e ? Object.create(e) : (n.prototype = e.prototype, new n)
		}),
		gr = function(t, e, n, r) {
			return new(n || (n = Promise))(function(i, o) {
				function a(t) {
		...
		br = function(t) {
			function e(e) {
				...
				return n.thumbInfos = [], n.introUrl = "", n.albumId = "", n.title = "", n.imgPageInfos = [], n.imgHtmlParser = new Qn(e), n.cacheService = new pr(n), n
			}
			return mr(e, t), e.prototype.getPageCount = function() {
				...
				return void 0 === t && (t = !0), gr(this, void 0, void 0, function() {
					var e, n, r, i;
					return vr(this, function(o) {
						switch (o.label) {
							case 0:
			...
			}, e.prototype.getPreviewThumbnailStyle = function(t, e, n, r, i) {
				return gr(this, void 0, void 0, function() {
					var t;
					return vr(this, function(e) {
						return t = n.style + "; height: " + n.height + "px; width: " + n.width + "px; position: absolute; left: 50%; top: 50%;", n.height > n.width ? [2, t + "; transform: translate(-50%, -50%) scale(" + i / n.height + ")"] : [2, t + "; transform: translate(-50%, -50%) scale(" + r / n.width + ")"]
					})
				})
		...
		kr = function(t) {
			...
			return xr(e, t), e.prototype.isAlbumViewPage = function() {
				...
				t.prototype.initEHunter.call(this), Xn.createAppView("vue-container", "#app", Xn.launcher.setAlbumService(new br(document.documentElement.innerHTML)).setEHunterService({
					showEHunterView: this.showEHunterView
				}).setConfig(yr.a).instance())
			}, e
		}(wr),
		Sr = function() {
			function t(t) {
		...
		Or = function(t) {
			function e(e) {
				var n = t.call(this) || this;
				return n.thumbInfos = [], n.introParserResolves = [], n.initIntroParserStatus = "ready", n.introUrl = "", n.albumId = "", n.title = "", n.imgPageInfos = [], n.imgHtmlParser = new Sr(e), n
			}
			return Cr(e, t), e.prototype._getIntroParser = function() {
				return Ar(this, void 0, void 0, function() {
					var t = this;
					return Tr(this, function(e) {
						return [2, new Promise(function(e, n) {
							return Ar(t, void 0, void 0, function() {
								var t, n = this;
								return Tr(this, function(r) {
									switch (r.label) {
										...
										case 1:
											t = r.sent(), this.introParser = new Ir(t), this.introParserResolves.forEach(function(t) {
				...
				return Ar(this, void 0, void 0, function() {
					...
					return Tr(this, function(e) {
						switch (e.label) {
							...
							case 2:
								return [2, JSON.parse(JSON.stringify(this.imgPageInfos))]
						}
					})
				})
			}, e.prototype.getImgPageInfo = function(t) {
				...
				return Ar(this, void 0, void 0, function() {
					...
					return Tr(this, function(s) {
						switch (s.label) {
							...
							case 1:
								return null != (e = s.sent()).src && "" !== e.src ? [2, Er({}, e)] : ((n = new nr(e.pageUrl)).setTimeOutTime(5), [4, n.request()]);
							case 2:
								return r = s.sent(), i = new Sr(r), o = i.getImgUrl(), a = i.getImgHeight() / i.getImgWidth(), this.imgPageInfos[t].src = o, this.imgPageInfos[t].preciseHeightOfWidth = a, [2, Er({}, this.imgPageInfos[t])]
						}
					})
				})
			}, e.prototype.getNewImgSrc = function(t, e) {
				...
				return void 0 === t && (t = !1), Ar(this, void 0, void 0, function() {
					var e;
					return Tr(this, function(n) {
						switch (n.label) {
							case 0:
		...
		Mr = function(t) {
			...
			return Pr(e, t), e.prototype.isAlbumViewPage = function() {
				return null != window.location.pathname.match(/^\/g\/[0-9]*?\/[0-9]*\/$/)
			}, e.prototype.blockHostActions = function() {
				var t = document.createElement("script");
				t.innerHTML = "\n            console._clear = console.clear;\n            console.clear = function () {}\n        ", document.body.appendChild(t)
			}, e.prototype.initEHunter = function() {
				t.prototype.initEHunter.call(this), Xn.createAppView("vue-container", "#app", Xn.launcher.setAlbumService(new Or(document.documentElement.innerHTML)).setEHunterService({
					showEHunterView: this.showEHunterView
				}).setConfig(yr.a).instance())
            }, e
        }(wr);
    ...
    // =================================================================================
    // START: 在這裡貼上新的程式碼 (最終完美版)
    // =================================================================================

    //
    // WNACG - 解析器 (保持不變)
    //
    var WnacgImgHtmlParser = (function() {
        function WnacgImgHtmlParser(htmlText) {
            this.html = document.createElement("html");
            this.html.innerHTML = htmlText.replace(/src=/g, "x-src=");
        }
        WnacgImgHtmlParser.prototype.getImgUrl = function() {
            var imgElement = this.html.querySelector("img#picarea");
            if (!imgElement) return "";
            var src = imgElement.getAttribute("x-src");
            return src.startsWith('//') ? "https:" + src : src;
        };
        WnacgImgHtmlParser.prototype.getIntroUrl = function() {
            var breadcrumbLinks = this.html.querySelectorAll('.png.bread a');
            if (breadcrumbLinks.length < 4) {
                var imgElement = this.html.querySelector("img#picarea");
                if (!imgElement) return "/";
                var src = imgElement.getAttribute("x-src");
                var match = src.match(/\/data\/(\d+)\/(\d+)\//);
                if (match && match[1] && match[2]) {
                    var aid = match[1] + match[2];
                    return "/photos-index-aid-" + aid + ".html";
                }
                return "/";
            }
            var introLinkElement = breadcrumbLinks[breadcrumbLinks.length - 1];
            return introLinkElement.getAttribute('href');
        };
        WnacgImgHtmlParser.prototype.getPageInfo = function() {
            var pageLabelEl = this.html.querySelector('.newpagelabel');
            if (!pageLabelEl) return { current: 1, total: 1 };
            var pageMatch = pageLabelEl.textContent.match(/(\d+)\/(\d+)/);
            if (!pageMatch) return { current: 1, total: 1 };
            return {
                current: parseInt(pageMatch[1], 10),
                total: parseInt(pageMatch[2], 10)
            };
        };
        return WnacgImgHtmlParser;
    }());

    var WnacgIntroParser = (function() {
        function WnacgIntroParser(htmlText) {
            this.html = document.createElement("html");
            this.html.innerHTML = htmlText.replace(/src=/g, "x-src=");
        }
        WnacgIntroParser.prototype.getMaxPageNumber = function() {
            var pageLinks = this.html.querySelectorAll(".paginator a");
            var maxPage = 0;
            pageLinks.forEach(function(link) {
                var pageNum = parseInt(link.textContent, 10);
                if (!isNaN(pageNum) && pageNum > maxPage) maxPage = pageNum;
            });
            return maxPage || 1;
        };
        WnacgIntroParser.prototype.getImgUrls = function() {
            var items = this.html.querySelectorAll(".gallary_item");
            return Array.prototype.slice.call(items).map(function(item) {
                var link = item.querySelector(".pic_box a");
                var img = item.querySelector(".pic_box img");
                if (!link || !img) return null;
                var pageUrl = link.getAttribute("href");
                var thumbSrc = img.getAttribute("x-src");
                return {
                    id: pageUrl, pageUrl: pageUrl,
                    thumbSrc: thumbSrc.startsWith('//') ? "https:" + thumbSrc : thumbSrc,
                    thumbHeight: 212, thumbWidth: 150, heightOfWidth: 212 / 150, thumbStyle: ""
                };
            }).filter(function(item) { return item !== null; });
        };
        WnacgIntroParser.prototype.getTitle = function() {
            var h1Title = this.html.querySelector("h1, h2");
            if(h1Title) return h1Title.textContent.trim();
            var firstImg = this.html.querySelector(".gallary_item img");
            if (firstImg) {
                var altText = firstImg.getAttribute("alt") || "";
                return altText.replace(/_\d+$/, '').trim();
            }
            return "Unknown Title";
        };
        return WnacgIntroParser;
    }());


    //
    // WNACG - 服務 (最終優化版：初始階段獲取所有尺寸)
    //
    var WnacgAlbumService = (function() {

        // 將輔助函數放在閉包的頂部
        var fetchHtml = function(url) {
            return new Promise(function(resolve, reject) {
                var fullUrl = url.startsWith('http') ? url : 'https://www.wnacg.com' + url;
                GM_xmlhttpRequest({
                    method: 'GET',
                    url: fullUrl,
                    ...
                    onerror: function(error) { reject(new Error("Network error")); }
                });
            });
        };
        ...
        var getImageDimensions = function(url) {
            return new Promise(function(resolve) {
                ...
                img.onerror = function() {
                    // 如果圖片尺寸加載失敗，返回一個預設比例，避免程式崩潰
                    resolve({ width: 100, height: 140 });
                };
                img.src = url;
            });
        };

        function WnacgAlbumService(initialHtml) {
            this.imgPageInfos = [];
            this.title = "";

            var currentPath = window.location.pathname;
            if (currentPath.includes("/photos-view-id-")) {
                var parser = new WnacgImgHtmlParser(initialHtml);
                var pageInfo = parser.getPageInfo();
                this.currentPageNum = pageInfo.current;
                this.pageCount = pageInfo.total;
                this.introUrl = parser.getIntroUrl();
            } else {
                this.introUrl = currentPath;
            }

            var breadcrumbLinks = new DOMParser().parseFromString(initialHtml, 'text/html').querySelectorAll('.png.bread a');
            if (breadcrumbLinks.length >= 4) {
                var introLinkElement = breadcrumbLinks[breadcrumbLinks.length - 1];
                this.title = introLinkElement.textContent.trim();
            } else if (!this.title) {
        ...
        // --- 繼承 ---
        var _super = hr;
        WnacgAlbumService.prototype = Object.create(_super.prototype);
        WnacgAlbumService.prototype.constructor = WnacgAlbumService;

        // --- 核心資料獲取方法 ---
        WnacgAlbumService.prototype.getIntroUrl = function() { return this.introUrl; };
        WnacgAlbumService.prototype.getPageCount = function() { return Promise.resolve(this.pageCount); };
        WnacgAlbumService.prototype.getCurPageNum = function() { return Promise.resolve(this.currentPageNum); };
        WnacgAlbumService.prototype.getTitle = function() { return Promise.resolve(this.title); };

        WnacgAlbumService.prototype.getImgPageInfos = function() {
            var _this = this;
            if (this.imgPageInfos.length > 0) {
                return Promise.resolve(JSON.parse(JSON.stringify(this.imgPageInfos)));
            }

            var slideUrl = this.getIntroUrl().replace('photos-index-aid-', 'photos-slide-aid-');

            return fetchHtml(slideUrl).then(function(slideHtml) {
                var galleryScriptMatch = slideHtml.match(/src="(\/photos-gallery-aid-.*?\.html)"/);
                if (!galleryScriptMatch) throw new Error("Could not find gallery script URL.");
                return fetchHtml(galleryScriptMatch[1]);
            }).then(function(galleryScriptText) {
                var writelnRegex = /document\.writeln\(".*?(var\s+imglist\s*=\s*\[[\s\S]*?\];).*?"\);/;
                var writelnMatch = galleryScriptText.match(writelnRegex);
                if (!writelnMatch || !writelnMatch[1]) {
                    throw new Error("Could not find 'imglist' definition inside document.writeln.");
                }
                var imglistScript = writelnMatch[1].replace(/\\"/g, '"');

                var imgArray;
                try {
                    var functionBody = 'var fast_img_host = "";\n' + imglistScript + '\nreturn imglist;';
                    imgArray = new Function(functionBody)();
                } catch (e) {
                    throw new Error("Execution of extracted imglist script failed: " + e.message);
                }

                if (!Array.isArray(imgArray) || imgArray.length === 0) throw new Error("'imglist' is not a valid array.");

                // 刪掉最後一張推廣圖
                if (imgArray.length > 0 && imgArray[imgArray.length - 1].url.includes('shoucang.jpg')) {
                    imgArray.pop();
                }

                // ** 關鍵實現：併發獲取所有圖片的尺寸 **
                var dimensionPromises = imgArray.map(function(item) {
                    var finalUrl = item.url.startsWith('//') ? "https:" + item.url : item.url;
                    return getImageDimensions(finalUrl);
                });

                return Promise.all(dimensionPromises).then(function(dimensionsArray) {
                    _this.imgPageInfos = imgArray.map(function(item, index) {
                        var finalUrl = item.url.startsWith('//') ? "https:" + item.url : item.url;
                        var dimensions = dimensionsArray[index];
                        var ratio = dimensions.height / dimensions.width;

                        return {
                            id: "page-" + (index + 1), index: index, pageUrl: "(from_gallery_script)",
                            src: finalUrl, thumbSrc: finalUrl,
                            heightOfWidth: ratio, // 應用每張圖片各自的精確比例
                            preciseHeightOfWidth: ratio, // 同上
                            thumbHeight: 212, thumbWidth: 150
                        };
                    });

                    if (_this.imgPageInfos.length !== _this.pageCount) {
                        _this.pageCount = _this.imgPageInfos.length;
                    }

                    return JSON.parse(JSON.stringify(_this.imgPageInfos));
                });
            });
        };

        WnacgAlbumService.prototype.getImgSrc = function(index) {
            return this.getImgPageInfos().then(function(infos) { return infos[index]; });
        };

        WnacgAlbumService.prototype.getThumbInfos = function() {
            return this.getImgPageInfos().then(function(infos) {
                return infos.map(function(info) {
                    return { id: info.id, src: info.thumbSrc, mode: 1, height: info.thumbHeight, width: info.thumbWidth };
                });
            });
        };

        // 其他輔助函數
        WnacgAlbumService.prototype.getAlbumId = function() { var match = this.getIntroUrl().match(/aid-(\d+)/); return match ? match[1] : 'unknown'; };
        WnacgAlbumService.prototype.getThumbInfo = function(index) { return this.getThumbInfos().then(function(infos) { return infos[index]; }); };
        WnacgAlbumService.prototype.getNewImgSrc = function(index) { return this.getImgSrc(index); };
        WnacgAlbumService.prototype.supportOriginImg = function() { return false; };
        WnacgAlbumService.prototype.supportImgChangeSource = function() { return false; };
        WnacgAlbumService.prototype.supportThumbView = function() { return true; };
        WnacgAlbumService.prototype.getPreviewThumbnailStyle = function(t, e, n, r, i) {
            return Promise.resolve({ "background-image": "url(" + n.src + ")", "background-size": "cover" });
        };

        return WnacgAlbumService;
    }());
    ...
    // WNACG - 啟動器
    //
    var WnacgLauncher = (function() {
        function WnacgLauncher() {}
        WnacgLauncher.prototype.init = function() {
            var _this = this;
            // ** 關鍵修正：新增一條規則來修覆 .label 的顏色 **
            var cssOverride = `
            .vue-container .tips {
                padding: 0 !important;
        ...
        `;
            var style = document.createElement('style'); style.type = 'text/css'; style.innerHTML = cssOverride;
            document.head.appendChild(style);

            if (this.isAlbumViewPage()) {
                this.createEhunterSwitch();
                Xn.SettingService.getEHunterStatus().then(function(status) {
                    if (status) { _this.toggleEHunterView(true); }
                });
            }
        };
        WnacgLauncher.prototype.isAlbumViewPage = function() {
            return window.location.pathname.includes("/photos-view-id-");
        };
        WnacgLauncher.prototype.blockHostActions = function() {
            var header = document.getElementById('header');
            var bodywrap = document.getElementById('bodywrap');
            if (header) header.style.display = 'none';
            if (bodywrap) bodywrap.style.display = 'none';
        };
        WnacgLauncher.prototype.unblockHostActions = function() {
            var header = document.getElementById('header');
            var bodywrap = document.getElementById('bodywrap');
            if (header) header.style.display = '';
            if (bodywrap) bodywrap.style.display = '';
        };
        WnacgLauncher.prototype.toggleEHunterView = function(shouldShow) {
            var container = document.getElementsByClassName("vue-container")[0];
            if (shouldShow) {
                this.blockHostActions();
                if (container) { container.style.top = "0"; document.body.style.overflow = "hidden"; }
                else { this.initEHunter(); }
            } else {
                this.unblockHostActions();
                if (container) { container.style.top = "-100%"; document.body.style.overflow = ""; }
            }
        };
        WnacgLauncher.prototype.initEHunter = function() {
            var _this = this;
            this.createEHunterContainer();

            var service = new WnacgAlbumService(document.documentElement.innerHTML);

            // ** 關鍵修正：正常創建 App，然後立即調度 setIndex **

            Xn.createAppView("vue-container", "#app", Xn.launcher
                             .setAlbumService(service)
                             .setEHunterService({ showEHunterView: _this.toggleEHunterView.bind(_this) })
                             .setConfig(yr.a)
                             .instance()
                            );

            // 在 App 創建完成後，立即獲取正確頁碼並更新狀態
            service.getCurPageNum().then(function(currentPageNumber) {
                // Ke 是全局可訪問的 Vuex Store 實例
                if (Ke && currentPageNumber > 1) {
                    // 使用 Vue.nextTick 確保在 DOM 更新周期中調度
                    // i.default 是 Vue 的實例
                    i.default.nextTick(function() {
                        Ke.dispatch("setIndex", {
                            val: currentPageNumber - 1, // 轉換為索引
                            updater: "WNACG_INIT" // 一個自定義的更新者名稱
                        });
                    });
                }
            }).catch(function(error){
                console.error("eHunter failed to dispatch initial page number:", error);
            });
        };
        WnacgLauncher.prototype.createEhunterSwitch = wr.prototype.createEhunterSwitch;
        WnacgLauncher.prototype.openEhunterBySwitch = wr.prototype.openEhunterBySwitch;
        WnacgLauncher.prototype.createEHunterContainer = wr.prototype.createEHunterContainer;
        return WnacgLauncher;
    }());
